...
ins = np.load('ins_raw.npy'.format(args.kind))
...
with strategy.scope():
    #model = alt_unet(ins_train.shape[1:])
    model = create_uNet(ins_train.shape[1:], nclasses=1,lambda_regularization=args.lambda_regularization,
...
# Save results
fbase = r"results/filters_{}_guass_0.1_unet_{}_multi_dropout_{}_batchsize_{}_{}_l2_{}_{}_opt_{}_{}_thres_{}".format(args.filters,args.error,args.dropout,args.batch_size,args.unet_type, args.lambda_regularization,args.kind,args.optimizer,args.type,args.thres)
