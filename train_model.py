...
import random, argparse, re, png, sklearn.metrics, sys, pickle, time
...
def create_parser():
    ...
    parser.add_argument('-exp_type',type=str,default='two_layers',help='How to name this model?')
...
ins_test, scalars = transform_test(ins_test,scalers)
...
if twice == True:
    ...
    history = model.fit(ins_train, outs_train,epochs=100, batch_size=370)
